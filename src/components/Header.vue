<template>
<div class="bg-brown-50">
  <div class="py-5 pt-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-0">
    <div class="relative flex items-center justify-between">
      <div class="flex items-center">
        <a href="/" aria-label="Company" title="Company" class="inline-flex items-center mr-8">
          <img src="../assets/cover.png" class="w-32">
        </a>
      </div>
      ...
      <ul v-else class="flex items-center hidden space-x-8 lg:flex">
        <li>
          <button href="/" aria-label="Log in" title="Log in" class="transition-colors duration-200 hover:text-logo-20">Log in</button>
        </li>
      </ul>
      <div class="lg:hidden">
        ...
        <div v-if="isMenuOpen" class="absolute top-0 left-0 w-full">
          <div class="p-5 bg-white border rounded shadow-sm">
            ...
            <nav>
              <ul class="space-y-4">
                <li>
                  <a href="/" aria-label="Our product" title="Our product" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Product</a>
                </li>
                <li>
                  <a href="/" aria-label="Our product" title="Our product" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Features</a>
                </li>
                <li>
                  <a href="/" aria-label="Product pricing" title="Product pricing" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Pricing</a>
                </li>
                <li>
                  <a href="/" aria-label="About us" title="About us" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">About us</a>
                </li>
                <li>
                  <a href="/" aria-label="Sign in" title="Sign in" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Sign in</a>
                </li>
                <li>
                  <a href="/"
...
<div class="relative bg-brown-50 px-2 pt-8 mx-auto lg:py-20 md:px-8 xl:px-20 sm:max-w-xl md:max-w-full">
  <div class="max-w-xl mx-auto lg:max-w-screen-xl">
    <div class="mb-16 lg:max-w-lg lg:mb-0">
      <div class="max-w-xl mb-6">
        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold text-gray-900 sm:text-4xl sm:leading-none">
          <span class="relative inline-block">
            <svg viewBox="0 0 52 24" fill="currentColor" class="absolute top-0 left-0 z-0 hidden w-32 -mt-8 -ml-20 text-logo-20 lg:w-32 lg:-ml-28 lg:-mt-10 sm:block">
              <defs>
            ...
            <span class="relative">Bring your</span>
          </span>
          Web 3 identity with you wherever you are online.<br>
      ...
      <div class="px-5 pt-6 pb-5 text-center border border-logo-20 rounded lg:w-full">
        <div class="mb-5 font-semibold">Get your wgmi.ID today</div>
        <div class="flex justify-center w-full mb-3">
          <a href="/"
            ...
            <div class="flex items-center">
              <button v-on:click.prevent="validate" class="mr-3 font-semibold text-white" data-modal-toggle="walletModal">
                Connect Wallet
              </button>
              <img src="https://img.icons8.com/ios-glyphs/30/ffffff/wallet-app.png" />
            </div>
          </a>
        </div>
        <p class="max-w-md px-5 mb-3 text-xs text-gray-600 sm:text-sm md:mb-5">
          Our wallet authentication services are powered by Moralis Web3 Technology AB. For any questions, contact us <a href="" class="text-blue-200">here</a>.
        </p>
        ...
        <button v-on:click.prevent="validate"
...
<div id="walletModal" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center h-modal md:h-full md:inset-0">
  <div class="relative px-4 w-full max-w-md h-full md:h-auto">
    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
      ...
      <!-- Modal body -->
      <div class="p-6">
        <p class="text-sm font-normal text-gray-500 dark:text-gray-400">No gas is needed to connect with our available wallet providers.</p>
        <ul class="my-4 space-y-3">
          <li>
            <a v-on:click="authMeta" class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
          ...
          <li>
            <a v-on:click="authPhantom" class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
              <svg class="h-5" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li>
            <a v-on:click="authConnect" class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
              <svg class="h-5" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs>
