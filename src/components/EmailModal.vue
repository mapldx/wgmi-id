    ...
    <div class="relative px-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                <h3 class="text-xl font-medium text-gray-900 dark:text-white">Sign Up with Email</h3>
                <div>
                ...
                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                    What's the difference between registering with a wallet and email? <a href="#" class="text-blue-700 hover:underline dark:text-blue-500">Read here</a>
                </div>
            </form>
        </div>
    </div>
